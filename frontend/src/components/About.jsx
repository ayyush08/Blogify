...
'>
            <div className='flex flex-col p-14 dark:text-white'>
            ...
            <h2 className='text-4xl dark:text-white font-motserrat font-bold'>Why Blogify?</h2>
            <ul className='text-xl italic pt-4 dark:text-white'>
                <li className=''>
